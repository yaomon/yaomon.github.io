(function() {
    function addEnemyInfo() {
        ...
        $("#sniper").data("info", {
            ...
            flavor: "\"<i>Not all higher powers are from this realm... Those who chose the unholy path of the Others exchange their waning sanity for an unusual power...</i><br>- Recount of Religion Vol II."
        });
        $("#whirleant").data("info", {
            name: "Whirleant", 
            ...
            flavor: "\"<i>From the corpses according come copius crops coursing, all along the forest floor. Never another wilting willow ever more...</i>\" <br>- Scylian Poet Yarchilov"
        });
        $("#zerkape").data("info", {
            name: "Zerkape", 
        ...
        items.each(function( index ) {
            if (index === 0) {
                $(this).css({
                    ...
                    'z-index': 10-index,
                    'transform': 'scale(400%)',
                    'filter': 'drop-shadow(0px 0.5px 1px rgba(200, 200, 200, 0.5)) drop-shadow(0px -0.5px 1px rgba(200, 200, 200, 0.5)) drop-shadow(0.5px 0px 1px rgba(200, 200, 200, 0.5)) drop-shadow(-0.5px 0px 1px rgba(200, 200, 200, 0.5))'
                });
